        ...
        try {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    JOptionPane.showMessageDialog(this, "Rekord został dodany!", "Sukces", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "Wystąpił błąd podczas dodawania rekordu!", "Błąd", JOptionPane.ERROR_MESSAGE);
                }
        } catch (IOException ex){
            ex.printStackTrace();
        }
    ...
    public void deleteRecord(){
        try {
            ...
            if(stringId != null && stringId !="") {
                ...
                JOptionPane.showMessageDialog(this, "Nie podano id!", "Błąd", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    public void updateRecord(){
        try {
            ...
            if(model.getRowCount()<=0){
                JOptionPane.showMessageDialog(this, "Brak danych w modelu!", "Błąd", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (id < firstId || id>lastId) {
                JOptionPane.showMessageDialog(this, "Niepoprawne ID rekordu!", "Błąd", JOptionPane.ERROR_MESSAGE);
                return;
            }
            int selectedRow = -1;
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                int responseCode = connection.getResponseCode();
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    // Aktualizuj model lub tabelę w aplikacji klienckiej
                    ...
                    // Zaktualizuj inne komórki w zależności od potrzeb
                    JOptionPane.showMessageDialog(this, "Rekord został zaktualizowany.", "Sukces", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "Wystąpił błąd podczas aktualizacji rekordu.", "Błąd", JOptionPane.ERROR_MESSAGE);
                }
            }
        }catch (IOException ex){
            ex.printStackTrace();
